...
$configs= [
  ...
  // 异常页面的模板文件
    'exception_tmpl'         => ROOT_PATH . 'public/jintao/error.html',
    // errorpage 错误页面
    //'error_tmpl'         => THINK_PATH . 'tpl' . DS . 'dispatch_jump.tpl',
  ...
  //分页配置
	...
	'RONG_DEV_APP_KEY'       => 'y745wfm8yjxzv', //融云开发环境下的key    仅供测试使用
	'RONG_DEV_APP_SECRET'    => 'fdIcenFQEUe2', //融云开发环境下的SECRET  仅供测试使用
	'RONG_PRO_APP_KEY'       => 'y745wfm8yjxzv', //融云生产环境下的key
	'RONG_PRO_APP_SECRET'    => 'fdIcenFQEUe2', //融云生产环境下的SECRET
