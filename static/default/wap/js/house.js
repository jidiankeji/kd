...
function caculate() {
    if (form1.loana_input.value == '' && form1.loanb_input.value == '' && form1.loanc_input.value == ''){
		layer.open({content:"商业贷款或者公积金贷款/n至少必须输入一项才能进行计算",time:2});
    ...
    if (form1.loana_input.value != '') {
        if (String(parseFloat(form1.loana_input.value)) == "NaN") {
			layer.open({content:"商业贷款金额不正确",time:2});
        ...
        if (form1.year1.value != '') {
            if (String(parseFloat(form1.year1.value)) == "NaN") {
				layer.open({content:"贷款年限不正确",time:2});
                form1.year1.value = "";
                form1.year1.focus();
                return;
            }
            if (parseFloat(form1.year1.value) > 30) {
				layer.open({content:"贷款年限不能超过30年",time:2});
                form1.year1.value = "";
                form1.year1.focus();
                return;
            }
			...
			layer.open({content:"您还没有输入贷款年限",time:2});
            form1.year1.focus();
            return;
        }
    ...
    if (form1.loanb_input.value != '') {
        if (String(parseFloat(form1.loanb_input.value)) == "NaN") {
			layer.open({content:"公积金贷款金额不正确",time:2});
    ...
    if (form1.loanc_input.value != '') {
        if (String(parseFloat(form1.loanc_input.value)) == "NaN") {
			layer.open({content:"消费贷款金额不正确",time:2});
        ...
        if (form1.year3.value != '') {
            if (String(parseFloat(form1.year3.value)) == "NaN") {
				layer.open({content:"消费贷款年限不正确",time:2});
                form1.year3.value = "";
                form1.year3.focus();
                return;
            }
            if (parseFloat(form1.year3.value) > 30) {
				layer.open({content:"消费贷款年限不能超过30年",time:2});
                form1.year3.value = "";
                form1.year3.focus();
                return;
            }
			...
			layer.open({content:"您还没有输入消费贷款年限",time:2});
            form1.year3.focus();
            return;
        }
...
function caculate1() {
    ...
    if (form1.loana_input.value != '') {
		...
		layer.open({content:"您还没有输入商业贷款金额",time:2});
        form1.loana_input.focus();
        return;
    }
    if (form1.year1.value != '') {
        if (String(parseFloat(form1.year1.value)) == "NaN") {
			layer.open({content:"商业贷款年限不正确",time:2});
            form1.year1.value = "";
            form1.year1.focus();
            return;
        }
        if (parseFloat(form1.year1.value) > 30){
			layer.open({content:"商业贷款年限不能超过30年",time:2});
            form1.year1.value = "";
            form1.year1.focus();
            return;
        }
		...
		layer.open({content:"您还没有输入商业贷款年限",time:2});
        form1.year1.focus();
        return;
    }
...
function caculate2() {
    ...
    if (form1.loanb_input.value != '') {
		...
		layer.open({content:"您还没有输入公积金贷款金额",time:2});
        form1.loanb_input.focus();
        return;
    }
    if (form1.year1.value != '') {
        ...
        if (String(parseFloat(form1.year1.value)) == "NaN") {
			layer.open({content:"公积金贷款年限不正确",time:2});
            form1.year1.value = "";
            form1.year1.focus();
            return;
        }
        if (parseFloat(form1.year2.value) > 30) {
			layer.open({content:"公积金贷款年限不能超过30年",time:2});
            form1.year1.value = "";
            form1.year1.focus();
            return;
        }
		...
		layer.open({content:"您还没有输入公积金贷款年限",time:2});
        form1.year1.focus();
        return;
    }
    form1.year2.value = form1.year1.value;
...
function caculate3() {
    ...
    if (form1.loanc_input.value != '') {
		...
		layer.open({content:"您还没有输入消费贷款金额",time:2});
        form1.loanc_input.focus();
        return;
    }
    if (form1.year3.value != '') {
