...
document.head.appendChild(document.createElement('script')).src = '/static/default/wap/js/clipboard.min.js?v=' + ~(-new Date());
...
$(function(){
	...
	var shareHtml = '<div class="HN_PublicShare_shearBox fn-hide"id="HN_PublicShare_shearBox"><div class="HN_PublicShare_sheark1"><div class="HN_PublicShare_sheark2"><div class="HN_PublicShare_HN_style_32x32"><ul class="fn-clear">' +
	  ...
	  '</div><div class="HN_PublicShare_bg"></div></div><div class="HN_PublicShare_zhiyin fn-hide"><div class="HN_PublicShare_bg"><div class="HN_PublicShare_zhibox"><img src="' + staticPath + '/HN_Public_sharezhi.png" alt=""></div></div></div>';
