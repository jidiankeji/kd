...
(function() {
	...
	MobileSelect.prototype = {
	    ...
	    getIndex: function(distance){//有修改
	        return Math.round((this.xiuzhengRow*this.liHeight-distance)/this.liHeight);
	    },
	    ...
	    calcDistance: function(index){//有修改
			return this.xiuzhengRow*this.liHeight-index*this.liHeight;
	    },
	    ...
	    fixPosition: function(distance){
	        return -(this.getIndex(distance)-this.xiuzhengRow)*this.liHeight;
	    },
	    ...
	    touch: function(event, theSlider, index){
	    	...
	    	switch(event.type){
	    		...
	    		case "touchend":
			        ...
			        _this.oversizeBorder = -(theSlider.getElementsByTagName('li').length-(_this.xiuzhengRow+1))*_this.liHeight;//有修改
			        //反弹
			        if(_this.curDistance[index] + _this.offsetSum > _this.xiuzhengRow*_this.liHeight){//有修改
			            _this.curDistance[index] = _this.xiuzhengRow*_this.liHeight;//有修改
			            setTimeout(function(){
			                _this.movePosition(theSlider, _this.curDistance[index]);
			            }, 100);
	    ...
	    dragClick: function(event, theSlider, index){
	    	...
	    	switch(event.type){
	    		...
	    		case "mouseup":
			        ...
			        _this.curDistance[index] = _this.fixPosition(_this.curDistance[index]);
			        _this.movePosition(theSlider, _this.curDistance[index]);
			        _this.oversizeBorder = -(theSlider.getElementsByTagName('li').length-(_this.xiuzhengRow+1))*_this.liHeight; 
			        //反弹
			        if(_this.curDistance[index] + _this.offsetSum > _this.xiuzhengRow*_this.liHeight){
			            _this.curDistance[index] = _this.xiuzhengRow*_this.liHeight;
			            setTimeout(function(){
			                _this.movePosition(theSlider, _this.curDistance[index]);
			            }, 100);
	    ...
	    singleClick: function(theLi, index, sliderIndex){
	        ...
	        if(_this.cascade){
		        ...
		        _this.curDistance[sliderIndex] = (_this.xiuzhengRow-index)*_this.liHeight;
