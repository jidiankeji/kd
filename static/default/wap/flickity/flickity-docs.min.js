...
FlickityDocs.modules["commercial-license-agreement"]=function(e){"use strict";function t(e){var t=o.querySelector(".is-selected");t&&classie.remove(t,"is-selected"),classie.add(e,"is-selected");for(var i=e.getAttribute("data-license-option"),l=r[i],a=0,s=n.length;s>a;a++){var c=n[a];utils.setText(c.element,l[c.property])}}var r={developer:{title:"Developer","for-official":"one (1) Licensed Developer","for-plain":"one individual Developer"},team:{title:"Team","for-official":"up to eight (8) Licensed Developer(s)","for-plain":"up to 8 Developers"},organization:{title:"Organization","for-official":"an unlimited number of Licensed Developer(s)","for-plain":"an unlimited number of Developers"}},o=e.querySelector(".button-group"),i=e.querySelector("h2"),l=i.cloneNode(!0);l.style.borderTop="none",l.style.marginTop=0,l.id="layer-url-btn",utils.setText(i,""),o.parentNode.insertBefore(l,o.nextSibling);for(var n=[],a=e.querySelectorAll("[data-license-property]"),s=0,c=a.length;c>s;s++){var p=a[s],u={property:p.getAttribute("data-license-property"),element:p};n.push(u)}t(o.querySelector(".button--developer")),eventie.bind(o,"click",function(e){matchesSelector(e.target,".button")&&t(e.target)})};
