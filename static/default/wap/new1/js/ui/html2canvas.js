 ...
 * Copyright (c) 2018 Niklas vonfxeks Hertzen <https://hertzen.com>
        ...
        ,
        {
          ...
          , F = e.createCounterText = function(A, e, t) {
            ...
            case a.LIST_STYLE_TYPE.SIMP_CHINESE_INFORMAL:
                return d(A, "闆朵竴浜屼笁鍥涗簲鍏竷鍏節", "鍗佺櫨鍗冭惉", "璐?", n, 14);
            ...
            case a.LIST_STYLE_TYPE.JAPANESE_INFORMAL:
                return d(A, "銆囦竴浜屼笁鍥涗簲鍏竷鍏節", "鍗佺櫨鍗冧竾", "銉炪偆銉娿偣", n, 0);
            case a.LIST_STYLE_TYPE.JAPANESE_FORMAL:
                return d(A, "闆跺１寮愬弬鍥涗紞鍏竷鍏節", "鎷剧櫨鍗冧竾", "銉炪偆銉娿偣", n, 7);
            case a.LIST_STYLE_TYPE.KOREAN_HANGUL_FORMAL:
                return d(A, "鞓侅澕鞚挫偧靷槫鞙§範韺旉惮", "鞁氨觳滊", "毵堨澊雱堨姢 ", B, 7);
            case a.LIST_STYLE_TYPE.KOREAN_HANJA_INFORMAL:
                return d(A, "闆朵竴浜屼笁鍥涗簲鍏竷鍏節", "鍗佺櫨鍗冭惉", "毵堨澊雱堨姢 ", B, 0);
            case a.LIST_STYLE_TYPE.KOREAN_HANJA_FORMAL:
                return d(A, "闆跺９璨冲弮鍥涗簲鍏竷鍏節", "鎷剧櫨鍗?", "毵堨澊雱堨姢 ", B, 7);
            ...
            case a.LIST_STYLE_TYPE.HIRAGANA:
                return C(A, "銇傘亜銇嗐亪銇娿亱銇嶃亸銇戙亾銇曘仐銇欍仜銇濄仧銇°仱銇︺仺銇伀銇伃銇伅銇层伒銇搞伝銇俱伩銈銈併倐銈勩倖銈堛倝銈娿倠銈屻倣銈忋倫銈戙倰銈?");
            case a.LIST_STYLE_TYPE.HIRAGANA_IROHA:
                return C(A, "銇勩倣銇伀銇汇伕銇ㄣ仭銈娿伂銈嬨倰銈忋亱銈堛仧銈屻仢銇ゃ伃銇倝銈銇嗐倫銇亰銇忋倓銇俱亼銇点亾銇堛仸銇傘仌銇嶃倖銈併伩銇椼倯銇层倐銇涖仚");
            case a.LIST_STYLE_TYPE.KANNADA:
                return g(A, 3302, 3311, !0, r);
            case a.LIST_STYLE_TYPE.KATAKANA:
                return C(A, "銈?偆銈︺偍銈偒銈偗銈便偝銈点偡銈广偦銈姐偪銉併儎銉嗐儓銉娿儖銉屻儘銉庛儚銉掋儠銉樸儧銉炪儫銉犮儭銉?儰銉︺儴銉┿儶銉儸銉儻銉般儽銉层兂", n);
            case a.LIST_STYLE_TYPE.KATAKANA_IROHA:
                return C(A, "銈ゃ儹銉忋儖銉涖儤銉堛儊銉儗銉儾銉偒銉ㄣ偪銉偨銉勩儘銉娿儵銉犮偊銉般儙銈偗銉ゃ優銈便儠銈炽偍銉嗐偄銈点偔銉︺儭銉熴偡銉便儝銉?偦銈?", n);
