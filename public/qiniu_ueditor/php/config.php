...
if($upload_type == "qiniu" && $ueconfig['http'] == 1){
	$host = 'https://'.$ueconfig['domain'];
}elseif($upload_type == "qiniu" && $ueconfig['http'] == 0){
	$host = 'http://'.$ueconfig['domain'];
}elseif($upload_type == "local" && $ueconfig['http'] == 1){
	$host = 'https://'.$ueconfig['domain'];
}elseif($upload_type == "local" && $ueconfig['http'] == 0){
	$host = 'http://'.$ueconfig['domain'];
}
